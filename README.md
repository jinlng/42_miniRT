...
- **Triangle**
```text
tr <v0 x,y,z> <v1 x,y,z> <v2 x,y,z> <r,g,b> (optionals: [material parameters])
```

#### Material Parameters
Material parameters are optional and parsed in this order:
...
| `roughness` | Surface Roughness | 0.0 = smooth / mirror, 1.0 = rough / matte |
...
The camera in MiniRT is a perspective camera with a position, orientation, and field of view (FOV). Rays are generated from the camera through each pixel on a virtual image plane.
